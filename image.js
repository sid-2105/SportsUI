...
export const imageSmall = {
    ...
    // }
    image: {
        maxWidth: variables.customIconDimension.smallIconWidth,
        maxHeight:variables.customIconDimension.smallIconHeight
    },
    container: {
        maxWidth: variables.customIconDimension.smallIconWidth,
        maxHeight: variables.customIconDimension.smallIconHeight
...
export const imageSmallest = {
    ...
    // }
    image: {
        maxWidth: variables.customIconDimension.smallestIconWidth,
        maxHeight:variables.customIconDimension.smallestIconHeight
    },
    container: {
        maxWidth: variables.customIconDimension.smallestIconWidth,
        maxHeight: variables.customIconDimension.smallestIconHeight
...
export const imageMedium = {
    ...
    image: {
        maxWidth: variables.customIconDimension.largeIconWidth,
        maxHeight: variables.customIconDimension.commonIconHeight
    },
    container: {
        maxWidth: variables.customIconDimension.largeIconWidth,
        maxHeight: variables.customIconDimension.commonIconHeight
...
export const imageLarge = {
    ...
    image: {
        maxWidth: variables.customIconDimension.largeIconWidth,
        maxHeight: variables.customIconDimension.largeIconHeight
    },
    container: {
        maxWidth: variables.customIconDimension.largeIconWidth,
        maxHeight: variables.customIconDimension.largeIconHeight
